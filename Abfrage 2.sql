...
INSERT INTO rezept (REZEPT_NR, REZEPT_NAME, ERNAEHRUNGSKATEGORIE, ZUTAT_ID, MENGE, GESAMTPREIS) VALUES (1, 'Mozzarella Tomate', 'Vegetarisch', 3002, 1 , 4.40 );

INSERT INTO rezept (REZEPT_NR, REZEPT_NAME, ERNAEHRUNGSKATEGORIE, ZUTAT_ID, MENGE, GESAMTPREIS) VALUES (1, 'Mozzarella Tomate', 'Vegetarisch', 1003, 2, 4.40 );

INSERT INTO rezept (REZEPT_NR, REZEPT_NAME, ERNAEHRUNGSKATEGORIE, ZUTAT_ID, MENGE, GESAMTPREIS) VALUES (2, 'Huevo Perico', 'Vegetarisch', 4001, 2, 1.50 );

INSERT INTO rezept (REZEPT_NR, REZEPT_NAME, ERNAEHRUNGSKATEGORIE, ZUTAT_ID, MENGE, GESAMTPREIS) VALUES (2, 'Huevo Perico', 'Vegetarisch', 1003, 1, 1.50 );

INSERT INTO rezept (REZEPT_NR, REZEPT_NAME, ERNAEHRUNGSKATEGORIE, ZUTAT_ID, MENGE, GESAMTPREIS) VALUES (2, 'Huevo Perico', 'Vegetarisch', 1002, 1, 1.50 );

INSERT INTO rezept (REZEPT_NR, REZEPT_NAME, ERNAEHRUNGSKATEGORIE, ZUTAT_ID, MENGE, GESAMTPREIS) VALUES (3, 'Wiener Couscous', 'Fleischhaltig', 6408, 1, 3.70 );

INSERT INTO rezept (REZEPT_NR, REZEPT_NAME, ERNAEHRUNGSKATEGORIE, ZUTAT_ID, MENGE, GESAMTPREIS) VALUES (3, 'Wiener Couscous', 'Fleischhaltig', 5001, 1, 3.70 );

INSERT INTO rezept (REZEPT_NR, REZEPT_NAME, ERNAEHRUNGSKATEGORIE, ZUTAT_ID, MENGE, GESAMTPREIS) VALUES (4, 'Kartoffel Karotten Mix', 'Vegan', 1006, 3, 1.35 );

INSERT INTO rezept (REZEPT_NR, REZEPT_NAME, ERNAEHRUNGSKATEGORIE, ZUTAT_ID, MENGE, GESAMTPREIS) VALUES (4, 'Kartoffel Karotten Mix', 'Vegan', 1005, 3, 1.35 );

INSERT INTO rezept (REZEPT_NR, REZEPT_NAME, ERNAEHRUNGSKATEGORIE, ZUTAT_ID, MENGE, GESAMTPREIS) VALUES (5, 'Spiegelei auf Butter gebraten', 'Vegetarisch', 3002, 2, 3.80 );

INSERT INTO rezept (REZEPT_NR, REZEPT_NAME, ERNAEHRUNGSKATEGORIE, ZUTAT_ID, MENGE, GESAMTPREIS) VALUES (5, 'Spiegelei auf Butter gebraten', 'Vegetarisch', 3002, 1, 3.80 );
